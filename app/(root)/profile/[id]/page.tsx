        ...
        <div className="flex flex-col items-start gap-4 lg:flex-row">
          ...
          <div className="mt-3">
            ...
            {userInfo.user.bio ? (
              ...
              <p className="paragraph-regular text-dark400_light800">No Bio</p>
            )}
          </div>
        </div>
          ...
          <SignedIn>
            {clerkId === userInfo.user.clerkId && (
              <Link href="/profile/edit">
                <Button className="paragraph-medium btn-secondary text-dark300_light900 min-h-[46px] min-w-[175px] p-4 py-3">
                  Edit Profile
                </Button>
              </Link>
            )}
